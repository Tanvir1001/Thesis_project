...
<div class="container">
    <div style="margin: 100px 200px 50px 200px; border: 2px solid red; border-radius: 15px" class="px-5 py-2">
        ...
        <h6>Price {{ $products->price }}/-</h6>
            ...
            <input type="number" style="width:100px" name="quantiry" value="1" min="1" max="40"> Kg 
            ...
            <div class="form-group  my-2">
                <label class="my-2">Your Name</label>
                <input type="text" class="form-control" name="vendorName" placeholder="Your Name" value={{
                    session('name') }}>
                <small class="error">
                    @error('vendorName'){{$message}}
                    @enderror
                </small>
            </div>
            ...
            <input type="text" hidden name="productId" value={{ $products->id }}>
            <input type="text" hidden name="sellerId" value={{ $products->sellerId }}>
            <input type="text" hidden name="vendorId" placeholder="vendor Id" value={{ session('id') }}>
            <button type="submit" class="btn btn-primary btn-sm">Submit</button>
        </form>
            @endif
