...
<body>
    ...
    <div class="row">
         ...
         <div class="col-3" style="min-height: 88vh; background-image: linear-gradient(45deg, #000000,#25C618)"> <!--(position,BottomLeft/TopRight) -->
            ...
            <div class="row" style="height: 90vh;" align="center">
                ...
                <div class="col-md-6">
                    <div class="d-flex align-items-center justify-content-center" style="height: 90vh;">
                        <div class="p-5"
                            style="border-radius: 10px; background: #198754; height: 400px; width:430px; box-shadow: 3px 3px 10px gray;">
                            <h4 class="mb-5 fw-bold text-white bg-dark text-uppercase">Admin Information</h4>
