...
use App\Http\Middleware\ValidVendor;
...
use App\Http\Middleware\ValidAdminOrVendor;
use App\Http\Middleware\ValidCustomerOrVendor;
...
Route::get('/products/{id}',[ProductController::class,'showProductDetails'])->name('products/{id}')->middleware([ValidCustomerOrVendor::class]);
// login controller
...
//  vendor controller
// edit vendor Profile 
Route::get('/vendorDashboard',[VendorController::class,'showvendorProfile'])->name('vendorDashboard');
Route::get('/editVendorProfile/{id}',[VendorController::class,'EditVendorProfile'])->name('editVendorProfile/{id}')->middleware([ValidVendor::class]);
Route::post('/updateVendorProfile',[VendorController::class,'updateVendorProfile'])->name('updateVendorProfile');
//add and show admin profile picture
Route::post('/vendorDashboard',[VendorController::class,'addVendorPhoto'])->name('vendorDashboard');
Route::get('/changeVendorImage/{id}',[VendorController::class,'changeVendorImage'])->name('changeVendorImage/{id}')->middleware([ValidVendor::class]);
Route::post('/updateVendorImage',[VendorController::class,'updateVendorImage'])->name('updateVendorImage');
// // delete admin account by admin own
// Route::get('deleteAdminAccount/{id}',[AdminController::class,'deleteAdminAccount'])->name('deleteAdminAccount/{id}')->middleware([ValidAdmin::class]);
Route::get('/productReviews/{id}',[VendorController::class,'vendorP_rating'])->name('productReviews')->middleware([ValidVendor::class]);
Route::get('/serviceReviews/{id}',[VendorController::class,'customerS_rating'])->name('serviceReviews')->middleware([ValidVendor::class]);
Route::get('/vendorList',[VendorController::class,'vendorList'])->name('vendorList')->middleware([ValidAdmin::class]);

// add vendor
Route::post('/addVendor',[VendorController::class,'listingVendor'])->name('addVendor')->middleware([ValidAdmin::class]);
Route::get('/addVendor',[VendorController::class,'allVendor'])->name('addVendor')->middleware([ValidAdmin::class]);

// order CRUD by (vendor)

// valid admin or customer 
// single customer many orders
Route::get('/vendorOrders/{id}',[VendorController::class,'vendorOrders'])->name('vendorOrders/{id}')->middleware([ValidAdminOrVendor::class]);
...
Route::post('/order/{id}',[OrderController::class,'confirmProductShow'])->name('order/{id}')->middleware([ValidCustomerOrVendor::class]);
Route::post('/order',[OrderController::class,'buyNow'])->name('order')->middleware([ValidCustomerOrVendor::class]);
...
//Route::post('addcart/{id}', [OrderController::class, 'addcart'])->name('addcart')->middleware([ValidCustomerOrVendor::class]);
...
// Route::get('/cart/{id}',[CartController::class,'confirmCartShow'])->name('cart/{id}')->middleware([ValidCustomerOrVendor::class]);
// Route::post('/cart/{id}',[OrderController::class,'confirmCartShow'])->name('cart/{id}')->middleware([ValidCustomerOrVendor::class]);
Route::post('/cart/{id}',[CartController::class,'addtocart'])->name('cart')->middleware([ValidCustomerOrVendor::class]);
Route::get('/cart-show/{id}',[CartController::class,'showcart'])->name('show.cart')->middleware([ValidCustomerOrVendor::class]);
Route::get('/remove_cart/{id}',[CartController::class,'remove_cart'])->name('remove.cart')->middleware([ValidCustomerOrVendor::class]);
/// Order
